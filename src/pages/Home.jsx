            ...
            <section className='grid place-items-center'>
                <article className='flex flex-col items-center'>
                    ...
                    <form onSubmit={handleSubmit} className='flex flex-col items-center gap-4 w-full h-24 md:h-12 md:flex-row md:gap-0 md:justify-center'>
                        ...
                        <button className='bg-red-500 shadow-md shadow-black/30 hover:bg-red-600 md:h-full text-white max-w-max px-10 py-2 rounded-md z-20 md:rounded-tl-none md:rounded-bl-none md:rounded-tr-md md:rounded-br-md'>Start</button>
                    </form>
                </article>
            </section>
